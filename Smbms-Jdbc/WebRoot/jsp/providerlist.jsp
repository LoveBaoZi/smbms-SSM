...
<div class="right">
	...
	<div class="search">
		<form method="get"
			action="${pageContext.request.contextPath }/Sys/pro/find">
			<span>供应商编码：</span> <input name="proCode" type="text"
				value="${queryProCode }"> <span>供应商名称：</span> <input
				name="proName" type="text" value="${queryProName }"> <input
				value="查 询" type="submit" id="searchbutton"> <a
				href="${pageContext.request.contextPath }/Sys/pro/addPro">添加供应商</a> <input
	...
	<table class="providerTable" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="provider" items="${page.proList }" varStatus="status">
			<tr>
				...
				<td><span> ${provider.creationDate}</span></td>
