...
<div class="right">
	...
	<div class="providerAdd">
		<form id="userForm" name="userForm" method="post"
			...
			action="${pageContext.request.contextPath }/Sys/user/addUserSave">
			...
			<div>
				<input type="hidden" id="errorinfo" vlaue="${uploadFileError}" /> <label
					for="a_idPicPath">证件照：</label> <input type="file" name="attachs"
					id="a_idPicPath" /> <font color="red"></font>
			</div>

			<div>
				<input type="hidden" id="errorinfo_wp" vlaue="${uploadWpError}" />
